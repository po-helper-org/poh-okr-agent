---
name: okr-context
description: Контекст-пак для формирования OKR — индекс .okr/index/ + предыдущий квартал (если есть) + LLM-синтез бизнес-целей. Готов за 1-2 минуты. Пак неполон — перезапусти /okr-index. Используй когда — /okr-context, собрать вводные квартала перед составлением OKR.
---

# Навык: Контекст-пак для формирования OKR
