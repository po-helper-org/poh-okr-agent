...
export interface TaskSummary {
  ...
  milestone?: string
  /**
   * ISO-время последней правки задачи. Отдельной отметки «когда выполнено» у Backlog.md нет,
   * и панель считает выполненное свежим по ней: для задачи, которую закрыли и больше не
   * трогали, это и есть момент закрытия.
   */
  updatedAt?: string
}
